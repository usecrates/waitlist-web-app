...
export function RebalanceModal({ open, onOpenChange, crate,stocksData }: RebalanceModalProps) {
  ...
  const reviewRows = [
    ...
    { stock: 'AAPL', current: '0.12 $30', allocation: '0.12 $30', action: 'Buy' },
    { stock: 'AVGO', current: '0.12 $30', allocation: '0.12 $30', action: 'EXIT' },
    { stock: 'GOOG', current: '0.10 $30', allocation: '0.08 $30', action: 'EXIT' },
    { stock: 'AMZN', current: '0.10 $30', allocation: '0.09 $30', action: 'EXIT' },
  ];
  const subtotal = 950;
  const slippage = 0.8;
  ...
  // Success mock data
  const filledRows = [
    { stock: 'AAPL', current: '0.12 $30', allocation: '0.12 $30', action: 'BOUGHT' },
    { stock: 'AAPL', current: '0.12 $30', allocation: '0.12 $30', action: 'BOUGHT' },
    { stock: 'AVGO', current: '0.12 $30', allocation: '0.12 $30', action: 'EXITED' },
    { stock: 'GOOG', current: '0.10 $30', allocation: '0.08 $30', action: 'EXITED' },
    { stock: 'AMZN', current: '0.10 $30', allocation: '0.09 $30', action: 'EXITED' },
  ];
                  ...
                  <tbody>
                    {reviewRows.map((row, i) => (
                      <tr key={i} className="border-t border-[#232323] text-base">
                        ...
                        <td className="py-2 px-2">{row.allocation}</td>
            ...
            <>
              ...
              <div className="border-[#484848] border-t p-3 mb-4">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-bold">Sold <span className="text-red-400">2</span> | Bought <span className="text-green-400">3</span></span>
                </div>
              </div>
              <div className="flex items-center gap-4 bg-[#232323] rounded-md p-3 mb-4 border border-[#484848]">
                <div className="p-[2px] rounded-lg" style={{ background: "linear-gradient(180deg, #8B8B8B 0%, #E9E9E9 50%, #8B8B8B 100%)" }}>
